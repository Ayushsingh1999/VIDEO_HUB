...
{  
    ...
    return (
        <>
        <Button pos={'fixed'} top={'4'}left ={'4'}colorScheme ={'purple'} p={'0'} w ={'10'} h ={'10'} borderRadius ={"full"} zIndex={'overlay'} onClick = {onOpen}><BiMenuAltLeft size ={'20'}  />
        </Button>
        ...
        <DrawerBody>
               {/*   flex direction vertical ho rhki hai align item bydefine center hai*/}
